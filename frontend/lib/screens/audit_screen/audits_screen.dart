...
class _AuditsScreenState extends State<AuditsScreen> {
  ...
  void _onDepartmentSelected(int? departmentId) {
    ...
    if (departmentId == null) {
      provider.fetchAllAudits();
    } else {
      provider.fetchAuditsByDepartment(departmentId);
    }
  }
                      ...
                      DataCell(
                        Tooltip(
                          ...
                          child: ConstrainedBox(
                            constraints: BoxConstraints(maxWidth: 200), // ограничение ширины
                            child: Text(
                              audit.description,
                              style: TextStyle(fontSize: 12),
                              maxLines: 3,
